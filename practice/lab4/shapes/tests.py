...
def test_create_rectangle_from_shape_controller():
    controller: ShapeController = ShapeController(test_print)
    params = ['0', '10', '100', '0', '15', '20']
    controller.execute_command('rectangle', params)
...
def test_create_circle_from_shape_controller():
    ...
    controller.execute_command('circle', params)
...
def test_create_triangle_from_shape_controller():
    ...
    controller.execute_command('triangle', params)
...
def test_create_line_segment_from_shape_controller():
    ...
    controller.execute_command('line_segment', params)
